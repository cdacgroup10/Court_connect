            ...
            <div className="row">
              <div className="col-lg-4 col-md-6 mb-4 mb-md-0">
                ...
                <p className="text-color">
                  Welcome to our Court Connect, your ultimate destination for
                  seamless sports experiences! Our platform is designed to
                  simplify the process of booking a turf, making it as easy as
                  1-2-3!
                </p>
              </div>
              ...
              <div className="container-fluid position-relative">
                <div className="col-lg-2 col-md-6 mb-4 mb-md-0">
                  <Link
                    to="/about"
                    className="active about-us-link"
